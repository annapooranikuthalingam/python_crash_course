"""
10-13. Verify User: The final listing for remember_me.py assumes either that the user has already
...
def greet_user():
    ...
    if username:
        response=input(f"Are you {username}?. Type 'Y' if yes or 'N' if no: ")
        if response=='Y':

"""
10-10. Common Words: Visit Project Gutenberg (https://gutenberg.org/) and find a few texts you’d
like to analyze. Download the text files for these works, or copy the raw text from your browser
...
you’re looking for, regardless of how it’s formatted.
...
such as 'then' and 'there'. Try counting 'the ', with a space in the string, and see how much lower
your count is.
"""
...
try:
    ...
    w_count=contents.lower().count('the')
    print(w_count)
    w_count_final=contents.lower().count('the ')
